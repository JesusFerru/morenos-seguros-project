...
export class NotificationsComponent implements OnInit, OnDestroy {
    ...
    markAllAsRead(): void {
        // Mark all as read
        const payload = {
            idPaymentGateway: this.notifications.map(notification => notification.id)
        };

        this._notificationsService.updateNotification(payload).subscribe((notifications: NotificationResult) => {
            // Load the notifications
    ...
    reloadNotification(): void {
        // Mark all as read
        this._notificationsService.getNotification().subscribe((notifications: Notification[]) => {
            // Load the notifications
            this._notificationsService.notification = notifications

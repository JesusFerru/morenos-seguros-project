...
To update the database use this command from the Web project folder (replace `MorenoSeguros` with your project's name):

```powershell
dotnet ef database update -c AppDbContext -p ../MorenoSeguros.Infrastructure/MorenoSeguros.Infrastructure.csproj -s MorenoSeguros.Web.csproj
```
